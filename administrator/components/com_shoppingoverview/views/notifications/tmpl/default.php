...
<div id="j-main-container" class="span10">
    ...
    <form id="adminForm" name="adminForm" method="post" action="/administrator/index.php?option=com_shoppingoverview&controller=notifications">
        ...
        <table class="adminlist table table-striped">
            ...
            <tr>
                <td colspan="8">
                    <button type="button" data-count="<?=$this->filter->limit?>" id="ajaxAdminNotificationsItems" class="btn btn-success btn-block btn-xs button-ajax_get_item">Показать ещё</button>
                </td>
            </tr>
            </tfoot>
        </table>

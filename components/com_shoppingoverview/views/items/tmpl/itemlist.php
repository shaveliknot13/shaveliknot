                ...
                <div class="original original_<?=$langBlock?>">
                    ...
                    for($i=1;$i<=10;$i++):
                        ...
                        <div class="addblock addblock_<?=$i?>">
                            ...
                            ?>
                            <div class="addphoto" <?=$style?>><?php echo JText::_('COM_SHOPPINGOVERVIEW_EDIT_FILD_24'); ?></div>
                            <input class="hidefile" accept="image/jpeg,image/png" type="file">
                            <textarea name="jform[myFieldset][text_<?=$langBlock?>][]" class="addtext" placeholder="<?php echo JText::_('COM_SHOPPINGOVERVIEW_EDIT_FILD_25'); ?>"><?php if(isset($baseTextRu[$i])): ?><?=$baseTextRu[$i]->text?><?php endif; ?></textarea>
                    ...
                    ?>
                    <div data-count="<?=$count?>" class="addphotooriginal_<?=$langBlock?> addphotooriginal"><?php echo JText::_('COM_SHOPPINGOVERVIEW_EDIT_FILD_26'); ?></div>

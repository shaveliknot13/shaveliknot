...
if($opacity) {
    ...
    $doc
        ...
        ->addScript($baseUrl . 'modules/mod_shoppingoverview_publications_filter/assets/js/shoppingoverview_publications_filter.js')
        ->addStyleSheet($baseUrl . 'components/com_shoppingoverview/assets/css/shoppingoverview.css')
        ->addStyleSheet($baseUrl . 'modules/mod_shoppingoverview_publications_filter/assets/css/shoppingoverview_publications_filter.css')
    ...
    require JModuleHelper::getLayoutPath('mod_shoppingoverview_publications_filter');
}
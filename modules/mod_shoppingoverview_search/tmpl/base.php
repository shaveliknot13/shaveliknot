...
<div class="mod_shoppingoverview_search">
    <form method="post" action="<?php echo JRoute::_( 'index.php?option=com_shoppingoverview&controller=search&Itemid=101' ); ?>">
        <div class="input-append">
            <input autocomplete="off" name="search" type="text" placeholder="<?php echo JText::_('MOD_SHOPPINGOVERVIEW_SEARCH_SEARCH2'); ?>" >
            <select name="type">
            ...
            <input class="btn btn-success" type="submit" value="<?php echo JText::_('MOD_SHOPPINGOVERVIEW_SEARCH_SEARCH'); ?>">
        </div>

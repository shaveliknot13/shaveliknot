...
?>
<div class="userProfileAmx profile-edit<?php echo $this->pageclass_sfx; ?>">
			...
			<?php if (count($fields)) : ?>
				<fieldset>
					...
					<?php foreach ($fields as $field) : ?>
                        <?php
                            if($field->fieldname == "editor" || $field->fieldname == "timezone"){
                                continue;
                            }
                        ?>
						...
						<?php else : ?>
							<div class="control-group">
								<div class="control-label">
                                    ...
                                    $haystack = $field->label;
                                    $needle1   = 'avatar';
                                    $needle2   = 'gender';

                                    $pos1      = strripos($haystack, $needle1);
                                    ...
                                    ?>
                                        ...
                                        if ($pos1 === false) {
                                            echo '<label id="jform_com_fields_gender-lbl" for="jform_com_fields_gender">'.JText::_('COM_SHOPPINGOVERVIEW_TEXT_44').'</label>';
                                        }else{
                                            echo '<label id="jform_com_fields_avatar-lbl" for="jform_com_fields_avatar">'.JText::_('COM_SHOPPINGOVERVIEW_TEXT_43').'</label>';
                                        }
								...
								<div class="controls">
                                    ...
                                    <?php
                                        ...
                                        $amx = str_replace('>Male<','>'.JText::_('COM_SHOPPINGOVERVIEW_TEXT_45').'<',$field->input);
                                        $amx = str_replace('>Female<','>'.JText::_('COM_SHOPPINGOVERVIEW_TEXT_46').'<',$amx);
                                        echo $amx;
                                    }
                                    ?>
